...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "bon": Label("//thirdparty/crates/bon-3.8.0:bon"),
            "reqwest": Label("//thirdparty/crates/reqwest-0.12.23:reqwest"),
            "serde": Label("//thirdparty/crates/serde-1.0.228:serde"),
            "tokio": Label("//thirdparty/crates/tokio-1.47.1:tokio"),
            "tonic": Label("//thirdparty/crates/tonic-0.14.2:tonic"),
            "tonic-health": Label("//thirdparty/crates/tonic-health-0.14.2:tonic_health"),
            "warp": Label("//thirdparty/crates/warp-0.4.2:warp"),
        },
    },
}
